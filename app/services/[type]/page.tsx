    ...
    return (
        <Page>
            <div className="flex flex-col lg:place-items-end gap-5 lg:gap-10 lg:grid lg:grid-cols-2">
                <Image src="/service-1.png" alt="banner" width={646} height={804} className="object-bottom w-full h-full aspect-video object-cover lg:aspect-auto" />
