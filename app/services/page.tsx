    ...
    return (
        <Page>
            ...
            <section className="flex flex-col gap-4 py-20 xl:py-32">
                <p className={cn(dmSans.className, "text-base lg:text-lg")}>En Estevez Estudio Jurídico ofrecemos una primera consulta para evaluar su situación legal y determinar la mejor estrategia para su caso. Nuestro equipo de profesionales lo acompañará durante todo el proceso, brindándole asesoramiento claro y soluciones adaptadas a sus necesidades particulares.</p>
                <p className={cn(dmSans.className, "text-base lg:text-lg")}>Contamos con amplia experiencia en las distintas ramas del derecho, lo que nos permite ofrecer un servicio integral y de calidad. Nos comprometemos a defender sus derechos con dedicación y transparencia, manteniéndolo informado en cada etapa del procedimiento legal.</p>
