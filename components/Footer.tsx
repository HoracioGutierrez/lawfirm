...
function Footer() {
    return (
        <footer className="px-6 py-10 md:px-10 lg:px-14 xl:px-20 bg-primary lg:py-12 xl:py-14">
            <div className="max-w-[1600px] mx-auto flex justify-center">
                <h2 className="flex flex-col items-center text-white xl:flex-row xl:gap-4">
            ...
            <div className="text-white flex flex-col md:flex-row items-start justify-between gap-12 max-w-[1600px] mx-auto">
                <div className="flex flex-col w-full gap-5 md:w-1/5">
                    ...
                    <nav className="flex gap-4">
                        <FacebookIcon className="transition-colors duration-300 hover:text-secondary" />
                        <LinkedinIcon className="transition-colors duration-300 hover:text-secondary" />
                        <TwitterIcon className="transition-colors duration-300 hover:text-secondary" />
                        <InstagramIcon className="transition-colors duration-300 hover:text-secondary" />
                    </nav>
                </div>
                <div className="flex-col hidden gap-5 md:w-1/5 md:flex">
                    <h3 className="text-2xl">Servicios</h3>
                    <nav className={cn(dmSans.className, "flex gap-4 flex-col")}>
                        <Link href="/services/penal" className="transition-colors duration-300 hover:text-secondary">Penal</Link>
                        <Link href="/services/comercial" className="transition-colors duration-300 hover:text-secondary">Comercial</Link>
                        <Link href="/services/civil" className="transition-colors duration-300 hover:text-secondary">Civil</Link>
                    </nav>
                </div>
                ...
                <div className="flex-col hidden gap-5 md:w-1/5 md:flex">
                    ...
                    <nav className={cn(dmSans.className, "flex gap-4 flex-col")}>
                        <Link href="/policies" className="transition-colors duration-300 hover:text-secondary">Politica de privacidad</Link>
                        <Link href="/terms" className="transition-colors duration-300 hover:text-secondary">Terminos y Condiciones</Link>
                        <Link href="/faq" className="transition-colors duration-300 hover:text-secondary">Preguntas Frecuentes</Link>
                    </nav>
                </div>
                <div className="flex flex-col w-full gap-5 md:w-1/5">
