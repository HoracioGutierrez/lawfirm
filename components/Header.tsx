        ...
        <header className={cn("p-6 md:p-10 lg:p-14 xl:p-20", path != "/" && "bg-primary text-white")}>
            <div className="max-w-[1600px] mx-auto flex items-center justify-between">
                ...
                <nav className={cn(dmSans.className, "hidden sm:flex sm:gap-12")}>
                    <Link href="/" className="text-xs transition-colors duration-300 md:text-sm lg:text-base xl:text-lg hover:text-secondary">Inicio</Link>
                    <Link href="/about" className="text-xs transition-colors duration-300 md:text-sm lg:text-base xl:text-lg hover:text-secondary">Quienes somos</Link>
                    <Link href="/services" className="text-xs transition-colors duration-300 md:text-sm lg:text-base xl:text-lg hover:text-secondary">Servicios</Link>
